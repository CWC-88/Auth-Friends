    ...
    render(){
        return(
            ...
            <div style={{display: `flex`, flexDirection: `column`, alignItems: `space-between`, justifyContent: `space-evenly`, position: `relative`, top: `-1500`}}>
                ...
                <form  style={{backgroundColor: `lightblue`, position: `relative`, left: `200px`, height: `250px`, width: `200px`, display: `flex`, flexDirection: `column`, padding: `35px`}} onSubmit={this.AddOne}
                >
